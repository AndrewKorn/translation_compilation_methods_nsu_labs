...
final public class Module_vnemo_parser {
	...
	public static final Object f_main() {
			...
			final Object l1_AST = Module_parsic.f_parsic(Module_vnemo_parser.f_lingoGrammar(), l0_test, Module_pegaction.g_defaultPegActions);
			return Module_runtime.f_println(l1_AST);
		}
}
