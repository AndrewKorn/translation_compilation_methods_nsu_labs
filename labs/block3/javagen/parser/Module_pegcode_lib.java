...
final public class Module_pegcode_lib {
	...
	public static final String f_captureEntry2String(Struct ap) {
			...
			case 67/*PegCaptureStartList*/: {
				return "<startlist>";
			}
			case 68/*PegCaptureStringStart*/: {
	...
	public static final Object f_evalActionExp(Struct ae, int ai, Struct aenv, Struct afns) {
			...
			case 3/*ActionCallDebug*/: {
				...
				case 48/*None*/: {
					...
					if ((((Struct)Module_dynamic.f_flow(l37_r)).getTypeId() == 26||Module_array.f_contains(l33_vargs, SingletonStructs.str_IllegalStruct))) {
