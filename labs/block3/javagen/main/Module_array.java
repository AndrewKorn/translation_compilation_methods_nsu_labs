...
final public class Module_array {
	public static final Struct f_array2list(Object[] aa) {
			final SingletonStruct l2_$1 = SingletonStructs.str_EmptyList;
			final Func2<Struct_Cons,Struct, Object> l3_$0 = (Func2<Struct_Cons, Struct, Object>)(Struct aac, Object ae) -> {
				return (new Struct_Cons(ae, aac));
			};
			return ((Struct)Native.fold(aa, l2_$1, ((Func2<Object,Object, Object>)(Func2)l3_$0)));
		}
	...
	public static final Object[] f_tail(Object[] aa) {
			return Native.subrange(aa, 1, (Native.length(aa)-1));
		}
	public static final Object[] f_take(Object[] aa, int acount) {
			if ((acount<=0)) {
				return SingletonStructs.arr_empty;
			} else {
				if ((acount>=Native.length(aa))) {
					return aa;
				} else {
					return Native.subrange(aa, 0, acount);
				}
			}
		}
}
