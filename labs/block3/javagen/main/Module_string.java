...
final public class Module_string {
	...
	public static final String f_concatStrings(Object[] astrings) {
			if ((Native.length(astrings)<35)) {
				final Func2<String,String, String> l1_$0 = (Func2<String, String, String>)(String aacc, String aval) -> {
					return (aacc+aval);
				};
				return ((String)Native.fold(astrings, "", ((Func2<Object,Object, Object>)(Func2)l1_$0)));
			} else {
				return Native.list2string(Module_array.f_array2list(astrings));
			}
		}
