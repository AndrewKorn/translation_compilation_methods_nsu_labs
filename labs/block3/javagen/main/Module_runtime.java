...
final public class Module_runtime {
	...
	public static final Object f_assert(boolean ab, String at) {
			if (!ab) {
				Module_runtime.f_println(("Assert failed. "+at));
				Native.printCallstack();
				return Native.failWithError(("Assert failed. "+at));
			} else {
				return null;
			}
		}
	...
	public static final Object f_for(Object ainit, Func1<Boolean,Object> apredicate, Func1<Object,Object> af) {
		TAIL_CALL: for(;;) {
			if (((boolean)apredicate.invoke(ainit))) {
				{
					final Object l0___tmp = af.invoke(ainit);
					ainit = l0___tmp;
					continue TAIL_CALL;
				}
			} else {
