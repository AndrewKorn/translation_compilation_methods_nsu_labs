...
final public class Module_executer {
	public static final Struct_Set f_AssignExecute(String avar, Struct aexpr, Object[] agoto, Struct_Configuration aconfiguration) {
			...
			if (Module_maybe.f_isNone(l0_vMay)) {
				...
				return Module_executer.f_emptyConfigurationSet();
			} else {
				final Struct l1_v = ((Struct)Module_maybe.f_either(l0_vMay, Module_executer.f_emptyInteger()));
				final Struct l2_gsymswitch0 = Module_executer.f_executeExpression(aexpr, aconfiguration.f_state);
				...
				case 114/*Some*/: {
					...
					case 32/*Integer*/: {
						...
						case 32/*Integer*/: {
							...
							return Module_executer.f_addAllGoto(agoto, l15_newState);
						}
						default: {
					...
					case 9/*Array*/: {
						...
						case 9/*Array*/: {
							...
							return Module_executer.f_addAllGoto(agoto, l22_newState);
						}
						default: {
	...
	public static final Struct_Set f_IfElseExecute(String acomparisonOp, Struct alExpr, Struct arExpr, Object[] aifGoto, Object[] aelseGoto, Struct_Configuration aconfiguration) {
			final Struct l0_gsymswitch1 = Module_executer.f_comparisonOperation(acomparisonOp, alExpr, arExpr, aconfiguration.f_state);
			...
			case 114/*Some*/: {
				...
				if (l4_isIf) {
					return Module_executer.f_addAllGoto(aifGoto, aconfiguration.f_state);
				} else {
					return Module_executer.f_addAllGoto(aelseGoto, aconfiguration.f_state);
				}
			}
			case 50/*None*/: {
				return Module_executer.f_emptyConfigurationSet();
	...
	public static final Struct_Set f_PrintExcecute(Struct aexpr, Object[] agoto, Struct_Configuration aconfiguration) {
			final Struct l0_gsymswitch2 = Module_executer.f_executeExpression(aexpr, aconfiguration.f_state);
			...
			case 114/*Some*/: {
				...
				Module_runtime.f_println(Module_executer.f_val2s(l4_valToPrint));
				return Module_executer.f_addAllGoto(agoto, aconfiguration.f_state);
			}
			case 50/*None*/: {
				return Module_executer.f_emptyConfigurationSet();
			}
	...
	public static final Struct_Set f_addAllGoto(Object[] agoto, Struct_MemoryState astate) {
			final Struct_Set l2_$1 = Module_executer.f_emptyConfigurationSet();
	...
	public static final Struct f_calcBinaryOperation(String abinaryOp, Struct aleft, Struct aright) {
					...
					if ((abinOp).equals("*")) {
						...
						if ((abinOp).equals("-")) {
							...
							if ((abinOp).equals("/")) {
								...
								return ((Integer)Module_executer.f_emptyInteger().f_val);
							}
						}
					}
				}
			...
			if ((Module_maybe.f_isNone(aleft)||Module_maybe.f_isNone(aright))) {
				...
				final Struct l1_gsymswitch5 = ((Struct)Module_maybe.f_either(aleft, Module_executer.f_emptyInteger()));
				...
				case 32/*Integer*/: {
					...
					final Struct l6_gsymswitch6 = ((Struct)Module_maybe.f_either(aright, Module_executer.f_emptyInteger()));
	...
	public static final Struct f_calcComparisonOperation(String acomparisonOp, Struct aleft, Struct aright) {
			...
			if ((Module_maybe.f_isNone(aleft)||Module_maybe.f_isNone(aright))) {
				...
				final Struct l2_gsymswitch3 = ((Struct)Module_maybe.f_either(aleft, Module_executer.f_emptyInteger()));
				...
				case 32/*Integer*/: {
					...
					final Struct l7_gsymswitch4 = ((Struct)Module_maybe.f_either(aright, Module_executer.f_emptyInteger()));
	...
	public static final Struct f_comparisonOperation(String acomparisonOp, Struct ale, Struct are, Struct_MemoryState astate) {
			return Module_executer.f_calcComparisonOperation(acomparisonOp, Module_executer.f_executeExpression(ale, astate), Module_executer.f_executeExpression(are, astate));
		}
	...
	public static final Struct f_executeExpression(Struct aexpression, Struct_MemoryState astate) {
			...
			case 12/*BinaryOp*/: {
				...
				return Module_executer.f_calcBinaryOperation(l5_binaryOp, Module_executer.f_executeExpression(l6_lExp, astate), Module_executer.f_executeExpression(l7_rExp, astate));
			}
			case 122/*Upd*/: {
				...
				return Module_executer.f_makeUpdOperation(Module_executer.f_executeExpression(l11_arrayExp, astate), Module_executer.f_executeExpression(l12_indexExp, astate), Module_executer.f_executeExpression(l13_newValueExp, astate));
			}
			case 8/*App*/: {
				...
				return Module_executer.f_makeAppOperation(Module_executer.f_executeExpression(l16_arrayExp, astate), Module_executer.f_executeExpression(l17_indexExp, astate));
			}
			case 123/*Var*/: {
	...
	public static final Struct_Set f_executeNextStatement(Struct_VnemoProg aprogram, Struct_Configuration aconfiguration, int amaxLabel) {
			if ((aconfiguration.f_label>amaxLabel)) {
				...
				switch (l1__tmp.getTypeId()) {
				case 11/*AssignStatement*/: {
					final Struct_AssignStatement l2__tmp = (Struct_AssignStatement)l1__tmp;
					...
					return Module_executer.f_AssignExecute(l8_var, l9_expr, l10_goto, aconfiguration);
				}
				case 27/*IfElse*/: {
					...
					return Module_executer.f_IfElseExecute(l18_comparisonOp, l19_lexpr, l20_rexpr, l21_ifGoto, l22_elseGoto, aconfiguration);
				}
				case 104/*PrintStatement*/: {
					final Struct_PrintStatement l2__tmp = (Struct_PrintStatement)l1__tmp;
					...
					return Module_executer.f_PrintExcecute(l27_expr, l28_goto, aconfiguration);
				}
				default:
					throw new RuntimeException("Unexpected struct in switch: "+l1__tmp.getTypeName());
				}
	...
	public static final Object f_executeVnemoProg(Struct_VnemoProg aprogram) {
			final int l0_maxLabel = Module_executer.f_findMaxLabel(aprogram.f_s);
			final Struct_Set l1_initSet = Module_set.f_buildSet((new Object[] { (new Struct_Configuration(0, Module_executer.f_initState(aprogram.f_d))) }));
			...
			final Func1<Struct_Set,Struct_Set> l3_nextStep = (Func1<Struct_Set, Struct_Set>)(Struct_Set as) -> {
				...
				final Func2<Struct_Set,Struct_Set, Struct_Configuration> l7_$4 = (Func2<Struct_Set, Struct_Set, Struct_Configuration>)(Struct_Set aacc, Struct_Configuration aconfiguration) -> {
					return Module_set.f_mergeSets(aacc, Module_executer.f_executeNextStatement(l4_program, aconfiguration, l0_maxLabel));
				};
				return ((Struct_Set)Module_set.f_foldSet(as, l6_$5, ((Func2<Object,Object, Object>)(Func2)l7_$4)));
			};
			final Struct_Set l5_execute = ((Struct_Set)Native.for_(l1_initSet, ((Func1<Boolean,Object>)(Func1)l2_exitPredicate), ((Func1<Object,Object>)(Func1)l3_nextStep)));
			return null;
		}
	...
	public static final Struct_MemoryState f_initState(Object[] avars) {
			...
			final Func2<Struct,Struct, Struct_VarDecl> l3_$0 = (Func2<Struct, Struct, Struct_VarDecl>)(Struct aacc, Struct_VarDecl avarDecl) -> {
				final Struct l4_gsymswitch12 = Module_tree.f_lookupTree(aacc, avarDecl.f_var);
				...
				case 114/*Some*/: {
					...
					Module_runtime.f_println((("Var="+avarDecl.f_var)+" already declared"));
					Module_runtime.f_assert(false, (("Var="+avarDecl.f_var)+" already declared"));
					return aacc;
				}
				case 50/*None*/: {
					return Module_tree.f_setTree(aacc, avarDecl.f_var, Module_executer.f_initType(avarDecl.f_type));
				}
				default:
	...
	public static final Struct f_initType(Struct atype) {
			...
			case 128/*bType*/: {
				...
				final String l2_b = l1__tmp.f_t;
				final String l3_b = l1__tmp.f_t;
				return Module_executer.f_emptyInteger();
			}
			case 127/*aType*/: {
				final Struct_aType l1__tmp = (Struct_aType)l0__tmp;
				final Struct l4_a = l1__tmp.f_t;
				final Struct l5_a = l1__tmp.f_t;
				return Module_executer.f_emptyArray();
			}
			default:
				throw new RuntimeException("Unexpected struct in switch: "+l0__tmp.getTypeName());
			}
	...
	public static final Struct f_makeAppOperation(Struct aarray, Struct aindex) {
			if ((Module_maybe.f_isNone(aarray)||Module_maybe.f_isNone(aindex))) {
				...
				final Struct l0_gsymswitch7 = ((Struct)Module_maybe.f_either(aarray, Module_executer.f_emptyArray()));
				...
				case 9/*Array*/: {
					...
					final Struct l5_gsymswitch8 = ((Struct)Module_maybe.f_either(aindex, Module_executer.f_emptyInteger()));
	...
	public static final Struct f_makeUpdOperation(Struct aarray, Struct aindex, Struct anewValue) {
			if (((Module_maybe.f_isNone(aarray)||Module_maybe.f_isNone(aindex))||Module_maybe.f_isNone(anewValue))) {
				...
				final Struct l0_gsymswitch9 = ((Struct)Module_maybe.f_either(anewValue, Module_executer.f_emptyInteger()));
				...
				case 32/*Integer*/: {
					...
					final Struct l5_gsymswitch10 = ((Struct)Module_maybe.f_either(aarray, Module_executer.f_emptyArray()));
					...
					case 9/*Array*/: {
						...
						final Struct l10_gsymswitch11 = ((Struct)Module_maybe.f_either(aindex, Module_executer.f_emptyInteger()));
